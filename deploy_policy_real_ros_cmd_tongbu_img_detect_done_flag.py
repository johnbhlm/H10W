...
from examples.H10W.robot_controller_done_flag import RobotController
...
stats = load_stats("/home/diana/intern-vla_test/starVLA/results/Checkpoints/gr00t_baseline_new_pre50k/dataset_statistics.json")
...
def main(args: Args):
    ...
    detector_client = DetectionClient3DSync("ws://10.8.26.53:8000")
        ...
        while True:
            ...
            while not task_complate:
                ...
                if "white-desk" in interface.target_location:
                    left_arm_joints[2] += 0.09
                    left_arm_joints[3] += 0.05
