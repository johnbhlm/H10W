...
class Args:
    ...
    pretrained_path: str = "./results/Checkpoints/internvla_no_tv_no_sofa_finetune"
...
task_list = {
    "1": "pick the plush green dinosaur toy from the desk with left hand",
    "2": "place the plush green dinosaur toy on the desk with left hand",
    "3": "pick the plush green dinosaur from the desk with right hand",
    "4": "place the plush green dinosaur on the desk with right hand",

    "5": "pick the plush yellow duck toy to the right of plush green dinosaur with the left hand",
    "6": "place the plush yellow duck toy to the right of plush green dinosaur with the left hand",
    "7": "pick the plush yellow duck toy to the left of plush green dinosaur with the left hand",
    "8": "place the plush yellow duck toy to the left of plush green dinosaur with the left hand",
    # "5": "pick the left green dinosaur toy ",
    # "6": "place the green dinosaur toy on the blue plate",
    # "7": "pick the right green dinosaur toy",
    # "8": "place the green dinosaur toy on top of plush orange lion",

    "9": "pick the plush yellow duck toy from the desk with the right hand",
    "0": "place the plush yellow duck toy on the desk with the right hand",
    "s": "pick the orange lion from the desk",
    "w": "place the plush toy on the desk",
    "r": "pick the orange lion toy from the desk with the right hand",
    "t": "place the orange lion toy on the desk",

    "a": "pick up the yellow duck toy on the desk with the left hand",
    "b": "place the plush yellow duck toy on the desk with the left hand",
    "c": "pick up the green dinosaur",
    "d": "place the plush green dinosaur toy on the blue plate with the left hand",
    "e": "pick the plush yellow duck on the left",
    "f": "pick the plush yellow duck on the right", 
    "g": "pick the plush yellow duck toy with the left hand", 
    "k": "place the plush green dinosaur toy on the blue plate on the desk with the left hand",
}
...
def main():
    ...
    try:
        while True:
            ...
            # plt.show()
            # plt.imshow(img_left)  # BGR → RGB
            # plt.show()
            # plt.imshow(img_right)  # BGR → RGB
            # plt.show()
