...
TARGET_POSE_TOLERANCE = 0.1 # m
STEP_COUNTER_THRESHOLD = 300
    ...
    try:
        while True:
            ...
            while not task_complate:
                ...
                both_close = (dl < TARGET_POSE_TOLERANCE and dr < TARGET_POSE_TOLERANCE)
                
                if both_close and step_counter > STEP_COUNTER_THRESHOLD:
                ...
                for i in range(actions.shape[0]- 8):
                    act = actions[i]
                    # for act in actions:
                    start = time.time()
                    step_counter += 1
            ...
            # if task_complate and "place" in task_description:
